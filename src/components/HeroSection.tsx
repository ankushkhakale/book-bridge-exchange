        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              <Button className="bg-bookbridge-purple hover:bg-bookbridge-darkpurple text-white px-6 py-6 h-auto">
                <BookOpen className="h-4 w-4 mr-2" />
                Browse Textbooks
              </Button>
              <Button variant="outline" className="border-bookbridge-purple text-bookbridge-darkpurple hover:bg-bookbridge-purple/10 px-6 py-6 h-auto">
          ...
          <div className="relative h-80 md:h-auto">
            ...
            <div className="absolute top-0 left-0 right-0 bottom-0 bg-white shadow-lg rounded-lg transform -rotate-3 overflow-hidden">
              <div className="h-full flex items-center justify-center bg-gradient-to-br from-white to-gray-100 p-8">
                <div className="relative max-w-sm mx-auto perspective-book">
                  <div className="book-shadow absolute"></div>
                  <div className="book">
                    <div className="front-cover">
                      <h3 className="text-center font-display font-semibold text-lg mb-2">Engineering Mathematics</h3>
                      <p className="text-center text-sm text-gray-600">₹450 • 60% off</p>
                    </div>
                  </div>
                </div>
              </div>
